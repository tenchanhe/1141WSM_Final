...
# # python3 My_RAG/main.py --query_path ./dragonball_dataset/queries_for_scorer_zh.jsonl --language zh --output ./predictions/predictions_zh.jsonl
# # python3 My_RAG/main.py --query_path ./dragonball_dataset/queries_for_scorer_en.jsonl --language en --output ./predictions/predictions_en.jsonl
...
PYTHONPATH=. python My_RAG/main.py \
    --query_path ./dragonball_dataset/test_queries_zh.jsonl \
    --language zh \
